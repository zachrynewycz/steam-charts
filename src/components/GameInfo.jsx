    ...
    return (  
        <div>
            <div className="flex justify-around bg-component-bg rounded-xl my-12 text-white font-pop_semi text-5xl pb-5">
                <h1 className="text-green-txt"><span className="text-lg">Playing Now</span><br/>{playerCount[0]}</h1>
                <h1><span className="text-lg">24 Hour Peak</span><br/>{playerCount[1]}</h1>
                <h1><span className="text-lg">All Time Peak</span><br/>{playerCount[2]}</h1>
            </div>
